...
int sqlite3_key_v2(sqlite3 *db,               /* Database to be rekeyed */
...
int sqlite3_rekey_v2(sqlite3 *db,               /* Database to be rekeyed */
                     const char *zDbName,       /* Name of the database */
                     const void *pKey, int nKey /* The new key */
);
...
*/
void sqlite3_activate_see(const char *zPassPhrase /* Activation phrase */
);
#endif
...
*/
void sqlite3_activate_cerod(const char *zPassPhrase /* Activation phrase */
);
#endif
...
*/
SQLITE_EXPERIMENTAL int sqlite3_snapshot_get(sqlite3 *db, const char *zSchema,
...
** [SQLITE_ENABLE_SNAPSHOT] compile-time option is used.
*/
SQLITE_EXPERIMENTAL int sqlite3_snapshot_open(sqlite3 *db, const char *zSchema,
...
*/
SQLITE_EXPERIMENTAL int sqlite3_snapshot_cmp(sqlite3_snapshot *p1,
                                             sqlite3_snapshot *p2);
